...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    public FilterChainProxy springSecurityFilterChain() throws ServletException, Exception {
        ...
        listOfFilterChains.add(new DefaultSecurityFilterChain(new AntPathRequestMatcher("/api/info")));
    ...
    public JSONPayloadAuthenticationFilter usernamePasswordAuthenticationFilter() throws Exception {
        ...
        LOGGER.debug("Preparing JSONPayloadAuthenticationFilter  ");
...
class StatelessSecurityContextRepository implements SecurityContextRepository {
    ...
    public void saveContext(SecurityContext context, HttpServletRequest request, HttpServletResponse response) {
        ...
        if (authToken != null) {
            LOGGER.info("Saving authentication token in the cache {}  with securityContext {} ", authToken, context);
...
class SecureResouceMetadataSource implements FilterInvocationSecurityMetadataSource {
    ...
    /** The logger. */
    private static final Logger LOGGER = LoggerFactory.getLogger(SecureResouceMetadataSource.class);
